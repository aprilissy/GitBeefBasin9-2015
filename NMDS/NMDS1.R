...
fit.den.l <- envfit(e.data.mds,den.l,perm=1000)
fit.den.d <- envfit(e.data.mds,den.d,perm=1000)
fit.den.l.d <- envfit(e.data.mds,den.l.d,perm=1000)
...
plot(fit.pls,col="dodgerblue", cex=0.9,font=2)
plot(fit.rlt,col="blue4", cex=0.9,font=2)
plot(fit.den.l,col="blue", cex=0.9,font=2)

plot(Plot)
title(main = "NMDS and Dead Classes")
# plot(fit.rds,col="orange", cex=0.9,font=2)
plot(fit.rdt,col="orange", cex=0.9,font=2)
plot(fit.den.d,col="red", cex=0.9,font=2)

plot(Plot)
title(main = "NMDS and Live+Dead Classes")
# plot(fit.rlds,col="chartreuse4", cex=0.9,font=2)
plot(fit.rldt,col="chartreuse4", cex=0.9,font=2)
plot(fit.den.l.d,col="green2", cex=0.9,font=2)
